...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $mail->From = 'info@shribalajiinstitutepune.com';
        $mail->FromName ='info@shribalajiinstitutepune.com'; 
		$mail->addAddress('info@shribalajiinstitutepune.com'); 
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Shri Balaji Insitute Pune.';
        $mail->isHTML(true);
